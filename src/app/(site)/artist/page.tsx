    ...
    <div className="relative bg-black">
      ...
      <section className="relative flex min-h-screen items-center justify-center px-6">
        <div className="absolute inset-0 overflow-hidden">
          {/* Saxophone background — hero only, left side */}
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <FadeIn delay={0.45}>
            <a
              href="#inscrever"
              className="mt-10 inline-block border border-wepac-gray/30 bg-white px-8 py-3 text-sm font-bold text-black transition-colors hover:bg-wepac-gray"
            >
              Inscrever na lista Beta
            </a>
            <p className="mt-3 text-xs text-white/40">
              Programa em fase Alpha. Serás informado quando a Beta abrir.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative z-10 bg-[rgba(255,255,255,0.02)] px-6 py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {AREAS.map((area, i) => (
              <FadeIn key={area.name} delay={i * 0.05} className="flex">
                <div className="flex flex-1 flex-col border border-wepac-gray/30 bg-black p-5 transition-colors hover:border-white">
                  <h4 className="font-barlow text-lg font-bold text-white">
                    {area.name}
                  </h4>
                  <p className="mt-1 text-sm text-white/50">
                    {area.desc}
      ...
      <footer className="relative z-10 border-t border-wepac-gray/30 px-6 py-16 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <FadeIn delay={0.15}>
            <div id="inscrever" className="mx-auto mt-10 max-w-md scroll-mt-24">
              <p className="text-sm text-white/80">
                O programa está em fase Alpha. Inscreve-te para seres informado
              ...
              >
                <input type="hidden" name="_subject" value="Inscrição Beta — Artistas WEPAC" />
                <input type="hidden" name="_captcha" value="false" />
                <input type="hidden" name="_next" value="https://wepac.pt/artist" />
                <input
                  type="email"
                  name="email"
                  required
                  placeholder="O teu email"
                  className="flex-1 border border-wepac-gray/30 bg-black px-4 py-3 text-sm text-white placeholder:text-white/30 focus:border-white focus:outline-none"
                />
                <button
                  type="submit"
                  className="border border-wepac-gray/30 bg-white px-6 py-3 text-sm font-bold text-black transition-colors hover:bg-wepac-gray"
                >
                  Inscrever
                </button>
              </form>
          ...
          <FadeIn delay={0.2}>
            <p className="mt-8 text-xs text-white/50">
              Programa em fase Alpha por convite. Candidaturas abertas em breve.
            </p>
          </FadeIn>
        </div>
      </footer>
