...
import type { UserRole, ArtistLevel, ArtistPhase, User } from "@/lib/types/artist";
...
export function AdminUsersPageClient({ users: allUsers }: AdminUsersPageProps) {
     ...
     {filtered.map((user) => (
      ...
      >
       <div className="flex items-center gap-4">
        <div className="flex h-10 w-10 items-center justify-centerbg-wepac-white/10 text-sm font-bold text-wepac-white">
         {user.name
          .split(" ")
          .map((n) => n[0])
          .join("")
