...
import type { User, Conversation } from "@/lib/types/artist";

interface MentorMessagesPageProps {
 conversations: Conversation[];
 users: User[];
 currentUserId: string;
}

export function MentorMessagesPageClient({ conversations: allConversations, users, currentUserId }: MentorMessagesPageProps) {
     ...
     <>
      ...
      <div className="border-t border-wepac-border p-4">
       ...
       >
        ...
        <button
         type="submit"
         className="bg-wepac-white px-6 py-3 text-sm font-bold text-wepac-black"
        >
         Enviar
        </button>
       </form>
