     ...
     {artists.map((artist) => {
      ...
      return (
       <Link
        ...
        className="flex items-center justify-between border border-wepac-border bg-wepac-card p-4 transition-colors hover:border-wepac-white/20"
       >
        <div className="flex items-center gap-4">
         <div className="flex h-10 w-10 items-center justify-center bg-wepac-white/10">
