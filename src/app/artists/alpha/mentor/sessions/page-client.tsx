...
import type { User, Session } from "@/lib/types/artist";
...
export function MentorSessionsPageClient({ sessions: rawSessions, users, artists }: MentorSessionsPageProps) {
    ...
    <div className="mt-6 border border-wepac-white/20 bg-wepac-card p-6">
     ...
     <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
       ...
       <select className="mt-1 w-full bg-wepac-input px-3 py-2 text-sm text-wepac-white">
     ...
     <div className="mt-4 flex gap-2">
      <button className="bg-wepac-white px-4 py-2 text-sm font-bold text-wepac-black">
       Criar
      </button>
      <button
