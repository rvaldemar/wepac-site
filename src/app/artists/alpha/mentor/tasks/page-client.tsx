...
import type { TaskStatus, User, Task } from "@/lib/types/artist";
...
interface MentorTasksPageProps {
 tasks: Task[];
 users: User[];
}

export function MentorTasksPageClient({ tasks, users }: MentorTasksPageProps) {
  ...
  <div className="p-6 lg:p-8">
   ...
   <div className="mt-6 space-y-2">
    {filtered.map((task) => {
     ...
     return (
      <div key={task.id} className="flex items-center justify-between border border-wepac-border bg-wepac-card p-4">
       <div>
