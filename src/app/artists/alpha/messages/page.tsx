...
import { getCurrentUser, mockConversations, mockUsers } from "@/data/artist-mock";
      ...
      <div className="w-72 flex-shrink-0 border-r border-wepac-border bg-wepac-black">
        ...
        <div className="overflow-y-auto">
          {conversations.map((convo) => {
            ...
            const hasUnread = lastMsg && !lastMsg.readAt && lastMsg.userId !== user.id;
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {hasUnread && (
                    <span className="h-2 w-2 rounded-full bg-wepac-borgonha" />
                  )}
                </div>
                {lastMsg && (
          ...
          <>
            ...
            <div className="border-t border-wepac-border p-4">
              ...
              >
                ...
                <button
                  type="submit"
                  className="rounded bg-wepac-borgonha px-6 py-3 text-sm font-bold text-wepac-white transition-colors hover:bg-wepac-borgonha-light"
                >
                  Enviar
                </button>
              </form>
