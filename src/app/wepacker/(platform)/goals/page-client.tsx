...
function StrategicPlanSection({
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-wepac-text-tertiary">
        {plan.quarter} — As quatro escalas dos teus Goals.
      </p>
  ...
  return (
    <div>
      ...
      <div className="mt-6 space-y-4 border border-wepac-border bg-wepac-card p-6">
        ...
        <div>
          <label className="block text-sm text-wepac-text-secondary">Focus Pillars</label>
...
function QuarterlyTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Focus Pillars */}
      <div className="border border-wepac-border bg-wepac-card p-5">
        <h3 className="text-sm font-bold text-wepac-white">Focus Pillars</h3>
        <div className="mt-2 flex flex-wrap gap-2">
          {plan.focusAreas.length === 0 && (
            <span className="text-xs text-wepac-text-tertiary">No Focus Pillars selected.</span>
          )}
  ...
  return (
    <div className="space-y-4">
      ...
      {plan.actions.length === 0 && !showForm && (
        <p className="text-sm text-wepac-text-tertiary">No Actions connected to this plan.</p>
      )}
