      ...
      <main className="sn-print-main">
        <div className="sn-print-wrap">
          ...
          <header className="sn-print-header">
            <div>
              <h1 className="sn-print-h1">{copy.admin.guestListTitle}</h1>
              <p className="sn-print-sub">{copy.common.eventDateWithTime}</p>
            </div>
            <div className="sn-print-meta">
              {copy.admin.generatedAt(generatedAt)}
            </div>
          </header>

          <section className="sn-print-totals">
            <div>
              <strong>{totalTickets}</strong> {copy.admin.tickets}
            </div>
            <div>
            ...
            <div>
              <strong>{checkedInCount}</strong> {copy.admin.admitted}
            </div>
            <div>
              <strong>{checkedInSeats}</strong> {copy.admin.seatsIn}
            </div>
          </section>
          ...
          <table className="sn-print-table">
            <thead>
              <tr>
                <th style={{ width: "10%" }}>{copy.admin.serial}</th>
                <th style={{ width: "22%" }}>{copy.common.name}</th>
                ...
                <th style={{ width: "32%" }}>{copy.admin.reservation}</th>
            ...
            <tbody>
              ...
              {tickets.map((t) => {
                ...
                const checkIn = t.checkedInAt
                  ? t.checkedInAt.toLocaleTimeString(locale, {
                      hour: "2-digit",
                      minute: "2-digit",
          ...
          <footer className="sn-print-footer">
            <p>{copy.admin.printInstructions}</p>
          </footer>
        </div>
      </main>
    </>
