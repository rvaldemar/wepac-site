...
export default function AgreementPage() {
  ...
  const commitments = wp(
    ...
    [
      "I commit to being present for the Sessions I accept, except in cases of force majeure communicated in advance.",
      "I commit to being punctual for the interactions I accept.",
      "I commit to giving and receiving feedback with honesty and respect.",
      "I commit to honoring the commitments and reflections I take on.",
      "I commit to remaining open to growth and constructive challenge.",
      "I commit to respecting the confidentiality of what others share with me.",
      "I commit to treating every person and community with care and responsibility.",
    ],
  );
    ...
    <div className="flex min-h-screen items-center justify-center bg-wepac-black px-6 pb-16 pt-16">
      ...
      <div className="w-full max-w-lg">
        <h1 className="font-barlow text-3xl font-bold text-wepac-white md:text-4xl">
          {wp(locale, "Acordo de Participação", "Participation Agreement")}
        </h1>
        <p className="mt-4 text-sm text-wepac-text-secondary">
          {wp(
            locale,
            "Para participar na WEPACKER, pedimos que leias e aceites os seguintes compromissos. São a base da nossa relação.",
            "To take part in WEPACKER, please read and accept these commitments. They are the foundation of our relationship.",
          )}
        </p>
        ...
        <div className="mt-10 border-t border-wepac-border pt-6">
          <label className="flex items-start gap-3">
            ...
            <span className="text-sm text-wepac-text-secondary">
              {wp(
                ...
                "I have read and accept the WEPACKER participation terms.",
              )}
            </span>
          </label>
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            >
              {loading
                ? wp(locale, "A processar...", "Processing...")
                : wp(
                    locale,
                    "Aceitar e abrir My Journey",
                    "Accept and open My Journey",
                  )}
            </button>
          </div>
        </div>
