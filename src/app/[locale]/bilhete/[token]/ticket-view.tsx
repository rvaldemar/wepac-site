...
export async function TicketView({ name, seats, serialCode, qrSvg }: Props) {
  const locale = await getLocale();
  const copy = getInstitutionalCopy(locale).ticketing;
  const startsAt = new Date("2026-04-21T19:00:00-03:00");
  const doorsAt = new Date("2026-04-21T18:30:00-03:00");
  ...
  const doorsTime = new Intl.DateTimeFormat(locale, {
    timeZone: "America/Fortaleza",
    hour: "numeric",
    minute: "2-digit",
  }).format(doorsAt);
        ...
        <div className="sn-ticket">
          <div className="sn-hero">
            <div className="sn-hero-overlay">
              <div className="sn-hero-top">
                ...
                <div className="sn-header-label">{copy.ticket}</div>
              </div>
              <div className="sn-hero-bottom">
                <div className="sn-hero-pre">{copy.preLaunchApril2026}</div>
          ...
          <div className="sn-container">
            ...
            <div className="sn-code-block">
              <div className="sn-code-label">{copy.entryCode}</div>
              <div
                className="sn-qr"
          ...
          <div className="sn-footer">
            <div className="sn-footer-brand">
              ...
              <div className="sn-tagline">{copy.transformativeCulture}</div>
            </div>
