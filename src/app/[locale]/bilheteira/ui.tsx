    ...
    <div style={styles.page}>
      <header style={styles.header}>
        <div>
          ...
          <span style={styles.brandSub}>{copy.brand}</span>
        </div>
...
export function formatPriceCents(cents: number, locale = "pt-PT"): string {
  if (cents === 0) {
    return getInstitutionalCopy(locale).ticketing.free;
  }
...
export function formatEventDate(d: Date, locale = "pt-PT"): string {
...
export function formatEventTime(d: Date, locale = "pt-PT"): string {
  return new Intl.DateTimeFormat(locale, {
    timeZone: LISBON_TZ,
    hour: "2-digit",
    minute: "2-digit",
